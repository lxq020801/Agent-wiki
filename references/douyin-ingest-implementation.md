...
vendor 锁定 httpx 0.27（0.28 删除了 proxies 参数），而用户本机的其他 Python 工具可能使用更新版本。**版本冲突必须用隔离 venv**。

```bash
# setup.sh 自动创建
<repo-root>/deps/douyin/.venv/
```
